...
class FileCopierTest extends FunSuite {
  test("basic") {
    ...
    assertResult("936a185caaa266bb9cbe981e9e05cb78cd732b0b3280eb944412bb6f8f8f07af")(copier.finalSha256)
  }
  ...
  test("basic2") {
    ...
    assertResult("cda6fa38611c153780f3a234cd986c51eb8de001aeab5fb5ca1c66506f0c83b4")(copier.finalSha256)
  }
}
